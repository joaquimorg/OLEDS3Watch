...
#define KEYBOARD_SPECIAL_COLOR  lv_color_hex(0xFFffff)
#define KEYBOARD_BG_COLOR       lv_color_hex(0x000000)

#define LABEL_PAD               4
#define LABEL_FONT_SMALL        &lv_font_montserrat_26
#define LABEL_FONT_BIG          &lv_font_montserrat_30
#define LABEL_COLOR             lv_color_hex(0xA0A0A0)
#define LABEL_FORMULA_LEN_MAX   256

#define APP_NAME                "Calculator"

// Adaptation for 360x360 round screen
#define SCREEN_360_EFFECTIVE_WIDTH  410  // Effective display area for round screen
#define SCREEN_360_EFFECTIVE_HEIGHT 502
...
bool Calculator::run(void)
{
    ...
    int y_offset = 0;  // Vertical offset
        ...
        y_offset = 15;  // Offset downward by 20 pixels to avoid round top
    ...
    if (is_round_screen) {
        lv_obj_align(keyboard, LV_ALIGN_BOTTOM_MID, 0, -20);  // Offset upward by 20 pixels
    } else {
