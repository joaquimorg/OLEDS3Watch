...
#define SCORE_TITLE_FONT        &lv_font_montserrat_18
...
bool Game2048::run()
{
    ...
    lv_obj_remove_flag(_foreground_grid, LV_OBJ_FLAG_SCROLLABLE);
...
{
    int score;
    systems::phone::Gesture::Info *type = (systems::phone::Gesture::Info *)lv_event_get_param(e);
    Game2048 *app = (Game2048 *)lv_event_get_user_data(e);
    ...
    if (!app->_anim_running_flag) {
        ...
        case systems::phone::Gesture::Direction::DIR_UP:
            // printf(NULL, "up");
            score = app->moveUp();
            break;
        case systems::phone::Gesture::Direction::DIR_DOWN:
            // printf(NULL, "down");
            score = app->moveDown();
            break;
        case systems::phone::Gesture::Direction::DIR_LEFT:
            // printf(NULL, "left");
            score = app->moveLeft();
            break;
        case systems::phone::Gesture::Direction::DIR_RIGHT:
            // printf(NULL, "right");
            score = app->moveRight();
            break;
        default:
